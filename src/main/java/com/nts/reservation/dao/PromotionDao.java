...
public class PromotionDao {
	...
	static final private String SELECT_PROMOTION_LIST = "SELECT promotion.id AS id, product_image.product_id AS product_id, file_info.save_file_name AS product_image_url "
